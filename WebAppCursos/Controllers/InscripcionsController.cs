...
namespace WebAppCursos.Controllers
{
    public class InscripcionsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["EstudianteID"] = new SelectList(_context.Estudiante, "ID", "Nombres", "Apellidos");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("InscripcionID,Grado,CursoID,EstudianteID,Fecha,Pago")] Inscripcion inscripcion)
        {
            ...
            ViewData["CursoID"] = new SelectList(_context.Curso, "CursoID", "Nombre", inscripcion.CursoID);
            ViewData["EstudianteID"] = new SelectList(_context.Estudiante, "ID", "Nombres", inscripcion.EstudianteID);
            return View(inscripcion);
        }
