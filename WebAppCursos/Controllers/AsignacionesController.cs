...
namespace WebAppCursos.Controllers
{
    public class AsignacionesController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["InstructorID"] = new SelectList(_context.Set<Instructor>(), "ID", "Nombres");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("AsignacionID,CursoID,InstructorID,Fecha")] Asignacion asignacion)
        {
            ...
            ViewData["CursoID"] = new SelectList(_context.Set<Curso>(), "CursoID", "Nombre", asignacion.CursoID);
            ViewData["InstructorID"] = new SelectList(_context.Set<Instructor>(), "ID", "Nombres", asignacion.InstructorID);
            return View(asignacion);
        }
